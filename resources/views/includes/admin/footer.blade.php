<footer class="footer">
    ...
    <script src="{{ asset('template/admin/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js') }}"></script>
    ...
    <script src="{{ asset('template/admin/assets/vendors/flot/jquery.flot.pie.js') }}"></script>
