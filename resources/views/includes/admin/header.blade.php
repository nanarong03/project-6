<div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="{{ url('/admin/home') }}"><img class="img-fluid mb-4" src="{{ asset('template/promote/images/belt.png') }}" alt="logo"
            width=250px></a>
        ...
        <ul class="nav"><br>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/admin/newandevent') }}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/admin/detailuser') }}">
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <img class="nav-profile-img mr-2" alt="" src="{{ asset('template/admin/assets/images/faces/user.png') }}" />
